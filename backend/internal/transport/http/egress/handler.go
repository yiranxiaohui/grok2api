...
func newNodeResponse(value egressdomain.PublicNode) nodeResponse {
	return nodeResponse{
		...
		ProxyConfigured: value.ProxyConfigured, ProxyPool: value.ProxyPool, ImportOnly: value.ImportOnly, UserAgent: value.UserAgent, CookieConfigured: value.CookieConfigured,
